...
public class Main2 {
    ...
    public static void main(String[] args) throws JsonProcessingException, FileNotFoundException {
        ...
        Phones editPhone = new Phones();
        PhonesBook phoneBook = new PhonesBook();

        phoneBook.add(new Phones("Петерсон Іванісов","2000-01-01","Дніпро","0673420774"));
        phoneBook.add(new Phones("Корпенко-Корий Петро","1878-11-12","Дніпро","0991232356"));
        phoneBook.add(new Phones("Васильків Гаврило","1978-06-13","Київ","0449876354"));
        phoneBook.add(new Phones("Яндекс Ольга","1997-12-24","Дніпро","0768765432"));
        phoneBook.add(new Phones("Шиповник Діма","1996-11-15","Київ","0954203830, 0671234567"));
        phoneBook.add(new Phones("Андроїд Миросько","2002-10-30","Дніпро","0973459673"));
        phoneBook.add(new Phones("Айфон Петро","1999-09-21","Київ","0932344556"));
        phoneBook.add(new Phones("Сильна Вероніка","1948-08-26","Дніпро","0734657346"));
        phoneBook.add(new Phones("Петроференц Жека","1994-07-06","Одеса","0664753963"));
        phoneBook.add(new Phones("Япончик Джон","1968-06-09","Івано-Франківськ","0687574938"));

        //show
        System.out.println("-----------------------------------------------------------");
        System.out.println("| Т Е Л Е Ф О Н Н И Й   Д О В І Д Н И К  ver.1.3.20211218 |");
        System.out.println("-----------------------------------------------------------");
        ...
        while (!("X".equalsIgnoreCase(choice)|"Ч".equalsIgnoreCase(choice))) {
            ...
            if ("F".equalsIgnoreCase(choice)|"А".equalsIgnoreCase(choice)) {
                ...
                String searchStr = choiceNew;

                cntSearch = phoneBook.stream()
                        .filter((p) -> p.toString().contains(searchStr)).count();

                if (cntSearch == 0) {
                    System.out.println("нічого не знайдено :(");
                } else {
                    System.out.println("знайдено " + cntSearch + " ел.:");
                }

                phoneBook.stream()
                        .filter((p) -> p.toString().contains(searchStr))
            ...
            if ("E".equalsIgnoreCase(choice)|"У".equalsIgnoreCase(choice)) {
                ...
                if (cntSearch == 0) {
                    ...
                    for (int i = 0; i < phoneBook.size(); i++) {
                        if (phoneBook.get(i).toString().contains(choiceNew)) {
            ...
            if ("=".equals(choice)) {
                ...
                while (!("X".equalsIgnoreCase(choiceField)|"Ч".equalsIgnoreCase(choiceField))) {
                    ...
                    if ("C".equalsIgnoreCase(choiceField)|"С".equalsIgnoreCase(choiceField)) {
                        ...
                        phoneBook.forEach((s) -> System.out.println(s));
                        break;
                    }
                    if ("B".equalsIgnoreCase(choiceField)|"И".equalsIgnoreCase(choiceField)) {
            ...
            if ("S".equalsIgnoreCase(choice)|"І".equalsIgnoreCase(choice)|"Ы".equalsIgnoreCase(choice)) {
                ...
                module.addSerializer(LocalDateTime.class, new LocalDtTmSerializers());
                module.addDeserializer(LocalDateTime.class, new LocalDtTmDeserializers());
            ...
            if ("O".equalsIgnoreCase(choice)|"Щ".equalsIgnoreCase(choice)) {
                ...
                while (!("X".equalsIgnoreCase(choiceField)|"Ч".equalsIgnoreCase(choiceField))) {
                    ...
                    try {
                        ...
                        PhonesBook phoneBook2 = gson.fromJson(bufferedReader, PhonesBook.class);
        ...
        //END
        System.out.println("Роботу з Довідником завершено, до нових зустрічей ;)");
